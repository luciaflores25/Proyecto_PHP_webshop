<?php
	...
	if ($totalRegistros > 0) {
    	...
    	$sql = "SELECT * FROM producto WHERE tipo=\"sudaderas\" ORDER BY id_producto DESC LIMIT ".$inicio."," . $regPorPag;

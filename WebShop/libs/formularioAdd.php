<?php
	...
	// guardamos los datos que se han introducido en el formulario para despues insertarlos en la base de datos
	if($_POST) {
	    $nombre = $_POST['nombre'];
		...
		$consulta = $lnk->query($sql);
	 	...
	 	// Si la consulta ha funcionado correctamente aparece el siguiente mensaje
	    if($consulta) {
	        echo '<p style="color="green;">Nuevo producto añadido correctamente</p>';
	    } else {
